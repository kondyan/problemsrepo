...
void solve(int T)
{
  string s; cin >> s;	int n = s.size();
	...
	// dp[L][R] the amount valid ways to empty the string from index L to index R;

	// if L > R (empty string)
	// what is the value if the segment length is odd? (cannot be emptied)
